...
public class CharacterView {
    ...
    public static void charClassElection(String name) {
        ...
        while (true) {
            ...
            switch (charClassOption.toLowerCase()) {
                case "1":
                case "cleric": {
                    player = CharacterController.createPlayer(name, "Cleric");
                ...
                case "2":
                case "mage": {
                    player = CharacterController.createPlayer(name, "Mage");
                ...
                case "3":
                case "monk": {
                    player = CharacterController.createPlayer(name, "Monk");
                ...
                case "4":
                case "paladin": {
                    player = CharacterController.createPlayer(name, "Paladin");
                ...
                case "5":
                case "ranger": {
                    player = CharacterController.createPlayer(name, "Ranger");
                ...
                case "6":
                case "rogue": {
                    player = CharacterController.createPlayer(name, "Rogue");
                ...
                case "7":
                case "warrior": {
                    player = CharacterController.createPlayer(name, "Warrior");
    ...
    public static void character(Player player) {
        while (true) {
            characterMenu();
            String valueChoose = IOView.menuOption();
            switch (valueChoose) {
                case "1": {
